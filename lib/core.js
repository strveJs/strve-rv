      ...
      if (options.mount) {
        ...
        effect(() => {
          ...
          if (this.isMountedComponent) {
            const oldTree = componentMap.get(this);
...
export { defineComponent, resetView, onMounted, onUnmounted, domInfo, version };
export * from '@vue/reactivity';

/**
 * 1. 引入 domInfo API；
 * 2. 引入 onMounted、onUnmounted API；
 * 3. 支持 @vue/reactivity 所有API；
 */
